...
rule annotated_features:
    input:
        ...
        confident="resources/annotations/{prefix}/genome.gtf.{tag}_confident.bed",
    output:
        features="resources/annotations/{prefix}/genome.gtf.{tag}_annotated.bed",
        feature_list="resources/annotations/{prefix}/genome.gtf.{tag}_feature_list.tab",
        long_intron="resources/annotations/{prefix}/genome.gtf.{tag}_long_intron.bed",
        long_exon="resources/annotations/{prefix}/genome.gtf.{tag}_long_exon.bed",
    params:
