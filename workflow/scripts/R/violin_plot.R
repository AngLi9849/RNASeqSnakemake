...
violin_caption <- paste(
  "Distribution of normalised ", difference, " of ", nrow(cts_genes_i), " ",  feature_i, " presented as violin and bar plot. Indicated significance of comparison is computed with ", as.character(test_p_i$method[1]), " method. (p=", test_p_i$p.format[1] , ", ", test_p_i$p.signif[1],")", sep=""
  )
