...
$6=="-" && ($7 != "gene" && $7 != "trscrpt") {
  if ($7 ~ "long_") {
    ...
    delete save ;
    gene=$4 ; a=$3 ; b=$2 ;  n=1 ; v=1 ; k=$12 ; $13=k ; $12=n ; $14=v ; save[1]=$0 ; 
...
#    } 
    ...
    if (a<b) {
      for (i in save) print save[i] ;
      delete save ;
      n+=1 ; b=$2 ; v=1 ; k=$12 ; $13=k ; $12=n ; $14=v ; save[1]=$0
    }
    else if (a>=b) {
      n+=0 ; b=b  ; k=k  ;
      if (k>$12 && ($7=="exon" || $7=="intron") ) {
        ...
        v+=1 ;  $13=k ; $12=n ; $14=v ;  save[length(save)+1]=$0 ;
      }
      else if (k<$12) {
        load=$0 ;
        for (i in save) {
...
$6=="+" && ($7 != "gene" && $7 != "trscrpt") {
  if ($7 ~ "long_") {
    ...
    for (i in save) print save[i] ;
    delete save ;
    gene=$4 ; c=$3 ; d=$2 ; w=$12 ; m=1 ; $13=m ;  save[1]=$0
 ...
 #   }
   ...
   if (c<d) {
      ...
      if (w>$12 && ($7=="exon" || $7=="intron") ) {
        ...
        w=$12 ; $13=m ;  save[length(save)+1]=$0
      }
      else if (w < $12) {
        load=$0 ; 
        for (i in save) {
